# AIRINONE_Platform
캐릭터 콘텐츠 제작을 위한 ARINONE 플랫폼 입니다.
...
ARINONE 플랫폼은   
대사생성을 위한 Speech maker   
생성된 대사에 맞는 애니메이션과 표정을 입히기 위한 Script editor   
콘텐츠의 시나리오 설정을 위한 Scenario editor   
최종적으로 콘텐츠를 제공하기 위한 ARINBody 클라이언트   
로 구성돼 있습니다.
